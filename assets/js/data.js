...
TD.MODULES = [
  /* Tujuh unit pertama mengikuti judul unit kompetensi RTA beserta kode
     SKKNI-nya. Dua unit terakhir ditandai tambahan: materinya berguna untuk
     praktik, tetapi bukan unit yang dinilai pada asesmen, sehingga tidak
     ikut dibagi pada paket Simulasi Sertifikasi. */
  { id:'rta-dasar',     level:'RTA', kode:'K.661238.001.01',
    name:'Menjelaskan Pengertian dan Penggunaan Analisis Teknikal', emoji:'🧭',
    desc:'Asumsi dasar, Dow Theory, tipe pasar, teknikal vs fundamental.' },
  { id:'rta-chart',     level:'RTA', kode:'K.661238.002.01',
    name:'Mengkonstruksi Grafik (Chart)', emoji:'📊',
    desc:'Line, bar, candlestick, point & figure, skala, timeframe.' },
  { id:'rta-trend',     level:'RTA', kode:'K.661238.003.01',
    name:'Menganalisis Kecenderungan Pergerakan Harga Efek', emoji:'📈',
    desc:'Garis tren, channel, struktur HH-HL, dan pola candlestick.' },
  { id:'rta-level',     level:'RTA', kode:'K.661238.004.01',
    name:'Menganalisis Support & Resistance Harga Efek', emoji:'🎚️',
    desc:'Support, resistance, Fibonacci, pivot point, gap.' },
  { id:'rta-kekuatan',  level:'RTA', kode:'K.661238.005.01',
    name:'Menganalisis Kekuatan dan Volatilitas Pergerakan Harga Efek', emoji:'💪',
    desc:'Volume, ATR, Bollinger, ADX, dan indikator berbasis volume.' },
  { id:'rta-pola',      level:'RTA', kode:'K.661238.006.01',
    name:'Menganalisis Pola Grafik (Chart Pattern)', emoji:'🔷',
    desc:'Pola pembalikan, penerusan, dwifungsi, dan perhitungan targetnya.' },
  { id:'rta-indikator', level:'RTA', kode:'K.661238.007.01',
    name:'Menganalisis Indikator Teknikal', emoji:'🧮',
    desc:'Moving average, MACD, RSI, stochastic, dan oscillator lainnya.' },
  { id:'rta-plan',      level:'RTA', tambahan:true,
    name:'Rencana Trading & Manajemen Risiko', emoji:'🛡️',
    desc:'Entry–exit, stop loss, target, risk/reward, jurnal trading.' },
  { id:'rta-riset',     level:'RTA', tambahan:true,
    name:'Menyusun & Mempublikasikan Riset Teknikal', emoji:'📝',
