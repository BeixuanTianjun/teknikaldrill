...
{id:"cta-sis-h01",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Menggembirakan, karena kinerja di luar sampel nyaris setara menandakan keunggulannya kokoh","Mengkhawatirkan, karena penurunan profit factor menandakan sistemnya mulai rusak","Belum bermakna, karena dua tahun terlalu pendek untuk pengujian di luar sampel","Mencurigakan, karena hasil yang terlalu mirip menandakan datanya bocor antar periode"],
 answer:0,
...
{id:"cta-sis-h02",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Data snooping, karena penutupan harian dipakai berulang untuk banyak pengujian","Look ahead bias, karena harga penutupan baru diketahui setelah sesi berakhir sehingga eksekusinya mustahil","Slippage yang diremehkan, karena eksekusi pada penutupan biasanya memperoleh harga lebih buruk","Survivorship bias, karena hanya emiten yang bertahan sampai akhir periode ikut terhitung"],
 answer:1,
...
{id:"cta-sis-h03",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Rentang 20 sampai 26 perlu diuji ulang dengan data yang lebih panjang","Perbedaan sebesar itu menandakan periode di sekitarnya salah dihitung","Puncak tunggal yang terisolasi menandakan hasilnya kebetulan, bukan keunggulan yang kokoh","Periode 23 adalah parameter optimal yang layak dipakai karena hasilnya paling tinggi"],
 answer:2,
...
{id:"cta-sis-h04",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Sistem itu cacat karena drawdown simulasinya jauh melampaui yang pernah terjadi","Simulasi tersebut tidak valid karena mengacak urutan transaksi yang sebenarnya berurutan","Drawdown historis lebih dapat dipercaya karena berasal dari data pasar yang nyata","Drawdown 12 persen kebetulan berasal dari urutan yang menguntungkan; siapkan diri untuk sekitar 27 persen"],
 answer:3,
...
{id:"cta-sis-h05",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Skewness negatif, dengan risiko sesungguhnya tersembunyi di ekor kiri distribusinya","Volatilitas tinggi, karena hasil satu transaksi jauh melampaui rata-ratanya","Overfitting, karena rangkaian kemenangan panjang menandakan parameter terlalu dicocokkan","Risk of ruin rendah, karena tingkat keberhasilannya mendekati sempurna"],
 answer:0,
...
{id:"cta-sis-h06",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Kedua rasio itu tidak dapat dibandingkan karena memakai satuan yang berbeda","Sistem kedua volatilitasnya terkonsentrasi pada pergerakan naik, yang tidak dihukum Sortino","Sistem kedua memiliki drawdown lebih dangkal sehingga rasionya ikut membaik","Sistem pertama menghasilkan lebih banyak transaksi sehingga volatilitasnya terdilusi"],
 answer:1,
...
{id:"cta-sis-h07",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Biaya tidak relevan karena dihitung dari nilai transaksi, bukan dari keuntungannya","Frekuensi tinggi justru menguntungkan karena biaya per transaksi menjadi lebih kecil","Biaya pulang pergi 0,3 persen menyisakan 0,1 persen, sehingga keunggulannya nyaris habis","Keuntungan bersih 0,25 persen per transaksi masih memadai untuk 600 transaksi setahun"],
 answer:2,
...
{id:"cta-sis-h08",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Menghentikan sistem segera karena kinerjanya sudah melampaui rangkaian terburuk historis","Menggandakan ukuran posisi karena kerugian beruntun biasanya diikuti kemenangan","Mengoptimalkan ulang parameternya memakai data terbaru agar kembali sesuai kondisi pasar","Memeriksa apakah delapan kerugian masih berada dalam sebaran wajar sistemnya sebelum menyimpulkan"],
 answer:3,
...
{id:"cta-br-h01",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Penurunan indeks didorong beberapa emiten berbobot besar, sementara pasar luas justru menguat","Data breadth tertinggal satu sesi dari perhitungan indeks komposit","Mayoritas saham naik tipis sementara sisanya turun sangat dalam secara merata","Indeks sedang mengalami penyesuaian komposisi sehingga angkanya tidak sebanding"],
 answer:0,
...
{id:"cta-br-h02",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Contrarian hanya berlaku pada indikator breadth, tidak pada indikator sentimen","Sentimen ekstrem dapat bertahan lama, sehingga tidak dapat dipakai menentukan waktu masuk","Put call ratio tinggi sebenarnya menandakan optimisme, bukan kepanikan pelaku pasar","Data opsi tidak mewakili pasar saham sehingga tidak relevan bagi keputusan itu"],
 answer:1,
...
{id:"cta-br-h03",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Menyempitnya spread imbal hasil antara tenor 10 tahun dan tenor 2 tahun","Naiknya rasio harga terhadap laba rata-rata emiten di indeks komposit","Melemahnya mata uang domestik terhadap dolar pada periode yang sama","Meningkatnya volume perdagangan pada bursa saham secara keseluruhan"],
 answer:2,
...
{id:"cta-br-h04",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Pasar memasuki fase akhir ekspansi, ketika sektor defensif biasanya memimpin","Pasar berada di awal pemulihan, ketika sektor siklikal keuangan biasanya memimpin","Rotasi sektor tidak membawa informasi apa pun tentang fase siklus ekonomi","Pasar memperkirakan tekanan inflasi berlanjut, sehingga sektor berbasis komoditas dicari"],
 answer:3,
...
{id:"cta-br-h05",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Pasar luas sedang menguat lebih dulu, yang umumnya merupakan tanda positif bagi indeks","Divergensi bearish, karena breadth seharusnya mengikuti indeks bukan mendahuluinya","Kesalahan perhitungan, karena AD Line tidak mungkin melampaui indeksnya","Indeks akan tetap tertinggal karena emiten besarnya sedang mengalami tekanan"],
 answer:0,
...
{id:"cta-br-h06",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Trader jangka pendek tidak memiliki akses terhadap data advance decline harian","Peringatannya muncul jauh sebelum titik balik, cocok untuk mengatur eksposur bertahap","Perhitungannya hanya tersedia pada data mingguan sehingga tidak relevan untuk jangka pendek","Divergensi breadth hanya berlaku pada portofolio yang terdiversifikasi luas"],
 answer:1,
...
{id:"cta-as-h01",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Biaya penyimpanan komoditas dibebankan langsung kepada pemegang kontrak berjangka","Kontrak berjangka tidak mengikuti harga spot sehingga keduanya tidak sebanding","Struktur contango membuat setiap rollover kontrak menggerus hasil posisinya","Harga spot dan harga kontrak berjangka bergerak berlawanan arah sepanjang tahun"],
 answer:2,
...
{id:"cta-as-h02",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Pasar memperkirakan inflasi jangka panjang melonjak jauh melampaui jangka pendek","Likuiditas pasar obligasi sedang mengering sehingga harganya tidak mencerminkan ekspektasi","Pemerintah sedang memperbanyak penerbitan obligasi bertenor panjang","Pasar memperkirakan pengetatan moneter jangka pendek yang berujung perlambatan pertumbuhan"],
 answer:3,
...
{id:"cta-as-h03",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Volatilitas tersirat anjlok setelah pengumuman, menggerus premi meski arahnya benar","Harga aset dasar belum melampaui strike sehingga opsinya tidak memiliki nilai","Opsi call tidak diuntungkan oleh kenaikan harga bila kenaikannya terjadi mendadak","Bursa membekukan perdagangan opsi selama periode pengumuman laba berlangsung"],
 answer:0,
...
{id:"cta-as-h04",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Indeks tersebut tidak mencakup seluruh saham sehingga tidak mewakili portofolio investor","Mata uang negara itu melemah lebih dari 12 persen terhadap mata uang asal investor","Dividen yang diterima dipotong pajak sehingga imbal hasil totalnya menjadi negatif","Biaya kustodian dan transaksi lintas negara melampaui kenaikan indeksnya"],
 answer:1,
...
{id:"cta-as-h05",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Sebagai indikasi bahwa commercial hedger sedang mengurangi aktivitas lindung nilainya","Sebagai tanda likuiditas pasar berjangka sedang berada pada level tertinggi","Sebagai peringatan contrarian, karena posisi ekstrem menyisakan sedikit pembeli baru","Sebagai konfirmasi tren naik, karena spekulan besar biasanya lebih tepat membaca arah"],
 answer:2,
...
{id:"cta-as-h06",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Pola teknikal tidak berlaku pada aset kripto sehingga sinyalnya acak","Perdagangan 24 jam membuat order stop loss tidak dapat dieksekusi dengan benar","Likuiditas kripto lebih besar sehingga harga bergerak lebih cepat menembus level","Volatilitasnya jauh lebih tinggi, sehingga jarak yang sama mewakili pergerakan yang jauh lebih kecil"],
 answer:3,
...
{id:"rta-plan-h01",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["100.000 lembar","80.000 lembar","125.000 lembar","50.000 lembar"],
 answer:0,
...
{id:"rta-plan-h02",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Negatif, karena tingkat keberhasilannya berada di bawah 50 persen","0,40R, sehingga 100 transaksi diharapkan menghasilkan sekitar 40R","1,05R, sehingga 100 transaksi diharapkan menghasilkan sekitar 105R","0,35R, sehingga 100 transaksi diharapkan menghasilkan sekitar 35R"],
 answer:1,
...
{id:"rta-plan-h03",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Risiko per posisi berkurang seiring bertambahnya jumlah posisi dalam portofolio","Stop loss pada lima posisi tidak mungkin tereksekusi seluruhnya pada hari yang sama","Korelasi tinggi antar saham sesektor membuat kelimanya berpeluang menyentuh stop bersamaan","Total risiko seharusnya dijumlahkan secara kuadrat, bukan secara langsung"],
 answer:2,
...
{id:"rta-plan-h04",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Sekitar 40 persen, sehingga pemulihannya sebanding dengan besarnya penurunan","Sekitar 50 persen, sehingga pemulihannya masih tergolong wajar bagi strategi aktif","Sekitar 80 persen, sehingga portofolio praktis tidak mungkin pulih kembali","Sekitar 67 persen, sehingga mencegah drawdown dalam jauh lebih bernilai daripada mengejar imbal hasil"],
 answer:3,
...
{id:"rta-plan-h05",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Batas kerugian menjadi tidak pernah pasti, sehingga ukuran posisi kehilangan dasar perhitungannya","Stop yang diperlebar selalu tersentuh juga pada akhirnya sehingga kerugiannya lebih besar","Level teknikal tidak boleh diubah setelah posisi dibuka karena melanggar aturan bursa","Memperlebar stop membuat rasio risiko imbal hasilnya otomatis menjadi negatif"],
 answer:0,
...
{id:"rta-plan-h06",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Risiko tidak dapat dihitung lagi karena stop sudah tidak berada di level teknikal","Risiko menjadi negatif karena stop sudah berada di atas harga masuk, sehingga keuntungan minimum terkunci","Risiko tetap sama karena dihitung dari harga masuk dan stop awal","Risiko bertambah karena jarak stop terhadap harga berjalan menjadi lebih jauh"],
 answer:1,
