...
{id:"cta-sis-h02",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Look ahead bias, karena harga penutupan baru diketahui setelah sesi berakhir sehingga eksekusinya mustahil","Slippage yang diremehkan, karena eksekusi pada penutupan biasanya memperoleh harga lebih buruk","Survivorship bias, karena hanya emiten yang bertahan sampai akhir periode ikut terhitung","Data snooping, karena penutupan harian dipakai berulang untuk banyak pengujian"],
 answer:0,
...
{id:"cta-sis-h04",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Drawdown 12 persen kebetulan berasal dari urutan yang menguntungkan; siapkan diri untuk sekitar 27 persen","Sistem itu cacat karena drawdown simulasinya jauh melampaui yang pernah terjadi","Simulasi tersebut tidak valid karena mengacak urutan transaksi yang sebenarnya berurutan","Drawdown historis lebih dapat dipercaya karena berasal dari data pasar yang nyata"],
 answer:0,
...
{id:"cta-sis-h06",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Sistem kedua volatilitasnya terkonsentrasi pada pergerakan naik, yang tidak dihukum Sortino","Sistem kedua memiliki drawdown lebih dangkal sehingga rasionya ikut membaik","Sistem pertama menghasilkan lebih banyak transaksi sehingga volatilitasnya terdilusi","Kedua rasio itu tidak dapat dibandingkan karena memakai satuan yang berbeda"],
 answer:0,
...
{id:"cta-br-h04",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Pasar memperkirakan tekanan inflasi berlanjut, sehingga sektor berbasis komoditas dicari","Pasar memasuki fase akhir ekspansi, ketika sektor defensif biasanya memimpin","Pasar berada di awal pemulihan, ketika sektor siklikal keuangan biasanya memimpin","Rotasi sektor tidak membawa informasi apa pun tentang fase siklus ekonomi"],
 answer:0,
...
{id:"cta-br-h06",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Peringatannya muncul jauh sebelum titik balik, cocok untuk mengatur eksposur bertahap","Perhitungannya hanya tersedia pada data mingguan sehingga tidak relevan untuk jangka pendek","Divergensi breadth hanya berlaku pada portofolio yang terdiversifikasi luas","Trader jangka pendek tidak memiliki akses terhadap data advance decline harian"],
 answer:0,
...
{id:"cta-as-h02",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Pasar memperkirakan pengetatan moneter jangka pendek yang berujung perlambatan pertumbuhan","Pasar memperkirakan inflasi jangka panjang melonjak jauh melampaui jangka pendek","Likuiditas pasar obligasi sedang mengering sehingga harganya tidak mencerminkan ekspektasi","Pemerintah sedang memperbanyak penerbitan obligasi bertenor panjang"],
 answer:0,
...
{id:"cta-as-h06",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Volatilitasnya jauh lebih tinggi, sehingga jarak yang sama mewakili pergerakan yang jauh lebih kecil","Pola teknikal tidak berlaku pada aset kripto sehingga sinyalnya acak","Perdagangan 24 jam membuat order stop loss tidak dapat dieksekusi dengan benar","Likuiditas kripto lebih besar sehingga harga bergerak lebih cepat menembus level"],
 answer:0,
...
{id:"rta-plan-h02",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["0,05R, sehingga 100 transaksi hanya diharapkan menghasilkan sekitar 5R","1,05R, sehingga 100 transaksi diharapkan menghasilkan sekitar 105R","0,35R, sehingga 100 transaksi diharapkan menghasilkan sekitar 35R","Negatif, karena tingkat keberhasilannya berada di bawah 50 persen"],
 answer:0,
...
{id:"rta-plan-h04",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Sekitar 67 persen, sehingga mencegah drawdown dalam jauh lebih bernilai daripada mengejar imbal hasil","Sekitar 40 persen, sehingga pemulihannya sebanding dengan besarnya penurunan","Sekitar 50 persen, sehingga pemulihannya masih tergolong wajar bagi strategi aktif","Sekitar 80 persen, sehingga portofolio praktis tidak mungkin pulih kembali"],
 answer:0,
