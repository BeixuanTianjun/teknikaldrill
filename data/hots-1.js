...
{id:"cta-sik-h02",module:"cta-siklus",level:"CTA",difficulty:"sulit",
 ...
 options:["Tren yang lebih besar sedang mendorong ke atas, sehingga fase naik memakan porsi waktu lebih panjang","Panjang siklusnya sedang memendek sehingga puncaknya bergeser ke belakang","Amplitudo siklus akan mengecil pada periode berikutnya","Siklus tersebut sedang bergeser fase dan titik awalnya perlu dihitung ulang"],
 answer:0,
...
{id:"cta-sik-h06",module:"cta-siklus",level:"CTA",difficulty:"sulit",
 ...
 options:["Proyeksi siklus menandai zona waktu berpeluang berbalik, bukan memastikan pembalikan terjadi","Proyeksi siklus hanya berlaku untuk keluar posisi, tidak pernah untuk masuk posisi","Tanggal proyeksi selalu meleset karena panjang siklus tidak pernah bilangan bulat","Siklus tidak dapat dipakai bersama analisis harga karena keduanya saling bertentangan"],
 answer:0,
...
{id:"cta-st-h02",module:"cta-statistik",level:"CTA",difficulty:"sulit",
 ...
 options:["B menghasilkan banyak keuntungan kecil tetapi sesekali kerugian sangat besar yang mengancam kelangsungannya","A lebih berisiko karena keuntungan besarnya jarang muncul sehingga hasilnya tidak dapat diandalkan","Keduanya setara karena rata-rata imbal hasilnya sama besar","B lebih aman karena distribusi imbal hasilnya terkumpul rapat di sekitar rata-rata"],
 answer:0,
...
{id:"cta-st-h04",module:"cta-statistik",level:"CTA",difficulty:"sulit",
 ...
 options:["Pertumbuhan majemuk mengikuti rata-rata geometris, yang selalu lebih kecil bila imbal hasilnya berfluktuasi","Terdapat kekeliruan penghitungan karena rata-rata aritmatik selalu mencerminkan hasil akhir","Biaya transaksi belum dikurangkan dari imbal hasil bulanan yang dilaporkan","Dua belas bulan terlalu pendek untuk menilai pertumbuhan majemuk sebuah strategi"],
 answer:0,
...
{id:"cta-st-h06",module:"cta-statistik",level:"CTA",difficulty:"sulit",
 ...
 options:["Mean reversion, karena nilai di bawah 0,5 menandakan kecenderungan berbalik arah","Mengikuti tren, karena nilai di bawah 0,5 menandakan pergerakan yang persisten","Membeli dan menahan, karena nilai itu menandakan pergerakan sepenuhnya acak","Arbitrase antar instrumen, karena nilai itu menandakan tidak ada keunggulan arah"],
 answer:0,
...
{id:"cta-ew-h02",module:"cta-elliott",level:"CTA",difficulty:"sulit",
 ...
 options:["Sekitar 1.605","Sekitar 1.485","Sekitar 1.785","Sekitar 1.300"],
 answer:0,
...
{id:"cta-ew-h04",module:"cta-elliott",level:"CTA",difficulty:"sulit",
 ...
 options:["Memperlakukannya sebagai tanda siklus mendekati akhir, dan mengencangkan pengendalian risiko","Menambah posisi, karena puncak baru mengonfirmasi tren yang masih berlangsung","Membalik posisi menjadi jual, karena divergensi volume memastikan pembalikan","Mengabaikannya, karena volume tidak relevan dalam kerangka Elliott Wave"],
 answer:0,
...
{id:"cta-ew-h06",module:"cta-elliott",level:"CTA",difficulty:"sulit",
 ...
 options:["Gelombang B yang mencetak puncak baru tampak seperti kelanjutan tren naik, padahal koreksi belum selesai","Gelombang C yang lebih dalam tampak seperti tren turun baru, padahal hanya bagian dari koreksi","Struktur ini melanggar aturan mutlak sehingga penghitungannya pasti keliru sejak awal","Gelombang A dan B memiliki panjang sama sehingga arah selanjutnya tidak dapat ditentukan"],
 answer:0,
