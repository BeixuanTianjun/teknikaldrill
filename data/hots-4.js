...
{id:"rta-trend-h04",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Penarikan tiga garis tren menandakan analisisnya keliru sejak garis pertama","Penembusan garis ketiga umumnya menegaskan tren naik sebelumnya telah berakhir","Setiap penembusan garis tren adalah sinyal jual yang berdiri sendiri","Garis ketiga akan bertahan karena kemiringannya paling landai di antara ketiganya"],
 answer:1,
...
{id:"rta-trend-h06",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Menutup seluruh posisi karena divergensi memastikan tren akan segera berbalik","Membalik posisi menjadi jual untuk menangkap pembalikan sedini mungkin","Mengabaikannya sepenuhnya karena struktur harga masih menunjukkan tren naik","Memperketat pengendalian risiko tanpa membalik posisi, karena divergensi bukan sinyal jual"],
 answer:3,
...
{id:"rta-level-h03",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["2.350, dan pivot selalu sama dengan harga penutupan sebelumnya","2.283, dan close di bawah pivot menandakan bias intraday cenderung negatif","2.317, dan close di atas pivot menandakan bias intraday cenderung positif","2.300, dan close tepat di pivot menandakan pasar dalam keseimbangan"],
 answer:2,
...
{id:"rta-ind-h02",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Ketiganya hanya berlaku pada pasar sideways sehingga sinyalnya tidak sah saat trending","Ketiganya menghasilkan nilai dalam skala berbeda sehingga tidak dapat dijumlahkan","Ketiganya mengukur momentum dari data yang sama, jadi kesepakatannya bukan konfirmasi independen","Ketiganya memakai periode berbeda sehingga sinyalnya tidak dapat dibandingkan langsung"],
 answer:2,
...
{id:"rta-ind-h05",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Perbedaan antara EMA 12 dan EMA 26 sudah berbalik menjadi negatif","Jarak antara MACD dan garis sinyalnya menyempit, sehingga percepatan momentum berkurang","MACD sudah berada di bawah garis sinyal sehingga tren berbalik menjadi turun","Volume yang menyertai kenaikan harga sedang menyusut selama tujuh sesi itu"],
 answer:1,
...
{id:"rta-riset-h01",module:"rta-riset",level:"RTA",difficulty:"sulit",
 ...
 options:["Pembaca akan menganggap rekomendasinya berlaku selamanya tanpa batas waktu","Analis kehilangan kesempatan menunjukkan kedalaman analisis teknikalnya","Pembaca tidak tahu kapan analisisnya terbukti keliru sehingga tidak dapat mengelola risikonya","Target harga tanpa level pembatalan melanggar ketentuan penulisan riset otoritas"],
 answer:2,
...
{id:"rta-riset-h02",module:"rta-riset",level:"RTA",difficulty:"sulit",
 ...
 options:["Tidak ada masalah selama kesepuluh rekomendasi itu benar-benar pernah diterbitkan","Masalahnya hanya pada format, karena rekam jejak sebaiknya disajikan dalam tabel","Tidak ada masalah karena materi pemasaran tidak tunduk pada standar riset","Cherry picking yang menciptakan gambaran kinerja menyesatkan bagi pembaca"],
 answer:3,
...
{id:"rta-riset-h04",module:"rta-riset",level:"RTA",difficulty:"sulit",
 ...
 options:["Penyebutan angka target dilarang dalam riset teknikal yang diterbitkan untuk publik","Analisis teknikal bekerja dalam probabilitas, sehingga kepastian semacam itu menyesatkan pembaca","Rentang tiga bulan terlalu pendek untuk proyeksi harga yang dapat dipertanggungjawabkan","Target harus dinyatakan dalam rentang, bukan angka tunggal, agar sesuai kaidah statistik"],
 answer:1,
...
{id:"cta-pf-h01",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Sekitar 2,8 persen, karena risiko berkorelasi dijumlahkan secara kuadrat","Tidak dapat diperkirakan tanpa mengetahui volatilitas masing-masing instrumen","Mendekati 5 persen, karena empat posisi berkorelasi berperilaku seperti satu posisi besar","Tetap 8 persen, karena risiko tiap posisi sudah dibatasi sampai level stop masing-masing"],
 answer:2,
...
{id:"cta-pf-h04",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Drawdown hanya penting bagi pengelola institusi, tidak bagi pemodal perorangan","Drawdown dalam menguji apakah strategi dapat dijalani, dan banyak pemodal keluar sebelum pulih","Drawdown dalam menandakan perhitungan imbal hasilnya mengandung kekeliruan","Imbal hasil yang sama berarti kedua strategi setara sehingga drawdown tidak relevan"],
 answer:1,
...
{id:"cta-cs-h01",module:"cta-candle",level:"CTA",difficulty:"sulit",
 ...
 options:["Berubah menjadi hanging man karena candle berikutnya menutup lebih rendah","Menjadi lebih kuat, karena volume rendah menandakan tekanan jual sudah habis","Gagal, karena penolakan harga rendah tidak didukung partisipasi maupun konfirmasi berikutnya","Tetap sah, karena bentuk hammer sudah memenuhi syarat proporsi badan dan sumbunya"],
 answer:2,
