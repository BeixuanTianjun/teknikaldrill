...
{id:"rta-dasar-h19",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Analisis per saham selalu lebih akurat daripada analisis yang menyertakan indeks","Sebagian besar pergerakannya ditentukan pasar, sehingga analisis tanpa konteks indeks kehilangan penggerak utamanya","Korelasi tinggi membuat analisis teknikal tidak berlaku pada saham tersebut","Saham berkorelasi tinggi hanya boleh dianalisis dengan pendekatan fundamental"],
 answer:1,
...
{id:"rta-dasar-h20",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Salah satu pasti melakukan kesalahan teknis dalam menarik garis","Perbedaan itu membuktikan analisis teknikal tidak dapat diandalkan","Keduanya bisa benar pada horizonnya masing-masing, sehingga horizon wajib dinyatakan","Yang memakai data lebih panjang pasti lebih benar karena sampelnya lebih besar"],
 answer:2,
...
{id:"rta-dasar-h21",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Indikator apa saja yang dipakai untuk menghasilkan sinyalnya","Berapa lama analis tersebut sudah berpengalaman di pasar","Pada saham apa saja metode itu diterapkan selama setahun","Berapa rata-rata besarnya untung dan rugi per sinyal, bukan hanya berapa persen yang benar"],
 answer:3,
...
{id:"rta-dasar-h22",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Premis itu berlaku untuk informasi yang dapat diketahui, dan Dow sendiri mengecualikan peristiwa mendadak","Lonjakan setelah berita membuktikan premis tersebut keliru sepenuhnya","Berita mendadak selalu sudah bocor sebelumnya sehingga tetap tercermin di harga","Premis itu hanya berlaku pada indeks, tidak pernah pada saham individual"],
 answer:0,
...
{id:"rta-dasar-h23",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Menurunkan ukuran posisi agar kerugian kecilnya tidak terasa","Mengenali dulu kondisi pasarnya, lalu memilih perangkat yang sesuai dengan kondisi itu","Memperbesar periode indikator tren sampai sinyal palsunya berkurang","Menambah indikator tren lain sebagai konfirmasi tambahan"],
 answer:1,
...
{id:"rta-dasar-h24",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Analis harus memeriksa ulang seluruh analisisnya setiap hari","Analis tidak dapat memakai indikator apa pun selain struktur harga","Analis akan selalu menyerahkan sebagian keuntungan di puncak dan sebagian kerugian di dasar","Analis tidak boleh pernah menutup posisi sebelum tren primer berakhir"],
 answer:2,
...
{id:"rta-plan-h19",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Sudah sesuai, karena nilai posisi hanya 30 persen dari modal","Terlalu kecil, karena batas 1,5 persen memungkinkan posisi yang lebih besar","Tidak dapat dinilai tanpa mengetahui volatilitas sahamnya","Terlalu besar, karena risikonya 9,6 juta atau 2,4 persen, melampaui batas yang ditetapkan"],
 answer:3,
...
{id:"rta-plan-h20",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Total heat 8 persen adalah batas atas, dan risiko sesungguhnya bergantung pada korelasi antarposisi","Risikonya tetap 1 persen karena setiap posisi memiliki stop sendiri","Risikonya pasti 8 persen karena kedelapan stop akan tersentuh bersamaan","Jumlah posisi tidak berpengaruh selama semuanya berada di sektor berbeda"],
 answer:0,
...
{id:"rta-plan-h21",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Memperbesar ukuran posisi pada pagi hari untuk menutup kerugiannya","Menjadikannya aturan tertulis untuk menunda entry, lalu memantau apakah polanya bertahan","Mengabaikannya karena waktu pembukaan posisi tidak memiliki dasar teoretis","Segera berhenti bertransaksi sepenuhnya pada pagi hari tanpa pengujian lanjutan"],
 answer:1,
...
{id:"rta-plan-h22",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Keduanya menghasilkan posisi yang persis sama besarnya","Pendekatan B melanggar prinsip pengendalian risiko karena ukurannya berubah-ubah","Stop A dapat berada di tempat yang tidak bermakna bagi pasar sehingga rawan tersentuh fluktuasi biasa","Pendekatan A lebih aman karena batas kerugiannya ditetapkan lebih dulu"],
 answer:2,
...
{id:"rta-plan-h23",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Sistemnya pasti rusak karena hasilnya berlawanan dengan expectancy","Expectancy tidak pernah berlaku pada praktik nyata, hanya pada perhitungan","Sampel 60 transaksi sudah cukup besar untuk membuktikan sistem itu gagal","Masih mungkin dalam sebaran wajar, dan yang perlu diperiksa lebih dulu adalah kesesuaian eksekusi dengan rencana"],
 answer:3,
...
{id:"rta-plan-h24",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Menyesuaikan jarak stop dengan volatilitas instrumen, bukan dengan angka R yang seragam","Memindahkan stop ke titik impas lebih cepat, yaitu saat untung 0,5R","Berhenti memakai stop sama sekali agar tidak pernah tersentuh","Memperbesar target agar rasio imbal hasilnya menutupi posisi yang tersentuh impas"],
 answer:0,
...
{id:"rta-plan-h25",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Terlalu konservatif, karena pemulihan 32 persen menuntut risiko di atas 5 persen","Berbahaya, karena memperbesar taruhan saat ekuitas menyusut mempercepat kemungkinan kehancuran","Wajar, karena diperlukan risiko lebih besar untuk memulihkan kerugian lebih cepat","Netral, karena persentase risiko tidak berpengaruh pada peluang pemulihan"],
 answer:1,
...
{id:"rta-trend-h16",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Menunggu harga kembali ke dalam segitiga sebelum mengambil keputusan apa pun","Membatalkan seluruh analisis karena polanya terbukti keliru sejak awal","Menerima penembusan itu, karena arah penembusan yang nyata mengalahkan kecenderungan pola","Menganggap penembusan itu palsu karena segitiga menaik selalu berakhir bullish"],
 answer:2,
...
{id:"rta-trend-h17",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Penembusan terbukti palsu dan posisi harus ditutup seluruhnya","Volume pada hari penembusan tidak bermakna karena sudah dibatalkan","Polanya berubah menjadi bearish dan layak dijadikan sinyal jual","Kemungkinan besar throwback biasa, karena penarikan turun tidak didukung partisipasi"],
 answer:3,
...
{id:"rta-trend-h18",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Tren naik harian sedang berlangsung di dalam tren turun mingguan yang belum berbalik","Kedua pembacaan bertentangan sehingga keduanya harus diabaikan","Grafik harian lebih mutakhir sehingga tren mingguan sudah tidak berlaku","Tren mingguan pasti akan segera berbalik naik mengikuti grafik harian"],
 answer:0,
...
{id:"rta-trend-h19",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Pola tersebut tetap sah dan harga pasti akan kembali turun ke neckline","Pola belum sah sebelum penembusan terjadi, sehingga bentuk saja tidak pernah cukup jadi dasar posisi","Pola head and shoulders memang tidak dapat diandalkan pada saham individual","Analisisnya keliru karena yang terbentuk pasti bukan head and shoulders"],
 answer:1,
...
{id:"rta-level-h12",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Keduanya setara karena keduanya sama-sama merupakan puncak sebelumnya","Level dari tiga tahun lalu sudah pasti tidak relevan lagi","Level 3.000 berpotensi lebih kuat karena banyak pemodal memiliki harga perolehan di sana","Level 2.950 pasti lebih kuat karena terbentuk paling baru"],
 answer:2,
...
{id:"rta-level-h13",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Siapa di antara keduanya yang lebih dulu menarik garis Fibonacci tersebut","Level mana yang lebih dekat dengan harga berjalan saat ini","Rata-rata dari kedua level tersebut, karena keduanya sama-sama sah","Apakah ayunan yang dijangkarkan merupakan pergerakan yang jelas terlihat pada timeframe yang dianalisis"],
 answer:3,
...
{id:"rta-level-h14",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Permintaan di level itu menipis, sehingga peluang support jebol pada pengujian berikutnya meningkat","Support semakin kuat karena berhasil bertahan sebanyak empat kali","Besarnya pantulan tidak berkaitan dengan kekuatan support","Harga akan memantul lebih tinggi pada pengujian kelima sebagai kompensasi"],
 answer:0,
...
{id:"rta-ind-h12",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Pelebaran pita hanya bermakna bila terjadi bersamaan dengan sinyal RSI","Pelebaran pita adalah akibat dari pergerakan itu sendiri, jadi belum tentu menandakan volatilitas akan berlanjut","Bollinger Bands tidak pernah dapat dipakai untuk menilai volatilitas","Volatilitas tinggi justru selalu merupakan kondisi terbaik untuk masuk"],
 answer:1,
...
{id:"rta-ind-h13",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Memakai sinyal dari grafik empat jam karena datanya paling mutakhir sehingga paling menggambarkan keadaan sekarang","Mengganti MACD dengan indikator lain yang perhitungannya tidak bergantung pada pilihan timeframe sama sekali","Memberi prioritas pada timeframe yang sesuai dengan horizon posisi, dan memakai yang lebih kecil untuk penentuan waktu","Memakai rata-rata dari kedua sinyal sebagai kesimpulan akhir, karena keduanya sama-sama sah secara perhitungan"],
 answer:2,
...
{id:"rta-ind-h14",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Segera menerapkannya karena hasil pengujian sudah membuktikan keunggulannya","Menurunkan periode lebih jauh lagi untuk mencari hasil yang lebih baik","Mengganti seluruh indikator lain dengan periode yang juga dipersingkat","Memeriksa apakah periode di sekitarnya juga membaik, dan mengujinya pada instrumen lain"],
 answer:3,
...
{id:"rta-riset-h09",module:"rta-riset",level:"RTA",difficulty:"sulit",
 ...
 options:["Pemilihan rentang waktu yang menguntungkan kesimpulan, sehingga pembaca kehilangan konteks penting","Tidak ada persoalan selama grafik enam bulan digambar dengan benar","Grafik lima tahun memang tidak pernah relevan untuk rekomendasi jangka pendek","Persoalannya hanya pada estetika penyajian, bukan pada isi analisisnya"],
 answer:0,
...
{id:"rta-riset-h10",module:"rta-riset",level:"RTA",difficulty:"sulit",
 ...
 options:["Analisis teknikal pada saham tipis selalu lebih akurat karena polanya bersih","Rekomendasi pada saham tipis dapat menggerakkan harganya sendiri, sehingga risiko bagi pembaca perlu dinyatakan","Saham tipis tidak boleh diulas dalam bentuk laporan apa pun","Jumlah pembaca tidak berpengaruh terhadap isi maupun cara penyajian laporan"],
 answer:1,
...
{id:"cta-teori-h21",module:"cta-teori",level:"CTA",difficulty:"sulit",
 ...
 options:["Keduanya identik dan hanya berbeda pada istilah yang dipakai","EMH berlaku pada saham, AMH hanya berlaku pada komoditas","EMH menyatakan keunggulan tidak pernah ada, AMH menyatakan keunggulan ada tetapi bersifat sementara","AMH menyatakan pasar selalu efisien, EMH menyatakan sebaliknya"],
 answer:2,
...
{id:"cta-teori-h22",module:"cta-teori",level:"CTA",difficulty:"sulit",
 ...
 options:["Spring, yaitu pengujian ke bawah yang berhasil dan menandakan akumulasi","Sign of strength yang menegaskan fase markup sedang dimulai","Selling climax yang menandakan pasokan telah habis terserap","Upthrust, yaitu pengujian ke atas yang gagal dan sering menandakan distribusi"],
 answer:3,
...
{id:"cta-teori-h23",module:"cta-teori",level:"CTA",difficulty:"sulit",
 ...
 options:["Keunggulan terkikis setelah pola dipublikasikan dan struktur pasar berubah, sesuai kerangka adaptif","Penelitian awal pasti mengandung kesalahan metodologis yang belum ditemukan","Pola tersebut akan kembali bekerja bila ditunggu cukup lama","Data setelah 1990 tidak dapat dipercaya karena perdagangan elektronik"],
 answer:0,
...
{id:"cta-elliott-h11",module:"cta-elliott",level:"CTA",difficulty:"sulit",
 ...
 options:["Tidak ada persoalan selama penghitungan barunya tidak melanggar aturan mutlak","Analisis yang tidak pernah dapat dinyatakan salah juga tidak pernah dapat diuji kebenarannya","Revisi penghitungan gelombang memang dilarang dalam kerangka Elliott Wave","Persoalannya hanya pada waktu yang terbuang untuk menghitung ulang"],
 answer:1,
...
{id:"cta-elliott-h12",module:"cta-elliott",level:"CTA",difficulty:"sulit",
 ...
 options:["Gelombang 3 akan segera berbalik karena bergerak terlalu cepat","Durasi gelombang lebih menentukan keabsahan daripada besaran pergerakannya","Kecepatan dan besaran gelombang 3 konsisten dengan wataknya sebagai gelombang paling bertenaga","Penghitungan pasti keliru karena gelombang 3 tidak boleh lebih cepat dari gelombang 1"],
 answer:2,
...
{id:"cta-siklus-h08",module:"cta-siklus",level:"CTA",difficulty:"sulit",
 ...
 options:["Tingkat ketepatan itu membuktikan siklus 18 bulan tidak nyata","Ketepatan 65 persen sudah cukup untuk dijadikan sinyal masuk otomatis","Jumlah 20 lembah terlalu sedikit untuk dinilai dalam bentuk apa pun","Tingkat ketepatan 65 persen berguna sebagai penyaring waktu, tetapi tidak cukup sebagai dasar tunggal"],
 answer:3,
...
{id:"cta-siklus-h09",module:"cta-siklus",level:"CTA",difficulty:"sulit",
 ...
 options:["Apakah ada perubahan nyata pada pasar yang menjelaskannya, atau ini sekadar mencocokkan ke data terbaru","Apakah periode 26 hari lebih dekat dengan bilangan Fibonacci","Apakah periode baru itu menghasilkan lebih banyak sinyal transaksi","Apakah rekan analis lain juga memakai periode yang sama"],
 answer:0,
...
{id:"cta-breadth-h07",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Penurunan persentase sebesar itu normal pada pasar mana pun dan tidak membawa informasi tambahan","Kerusakan internal jauh lebih luas daripada yang tampak pada indeks, sehingga risikonya lebih besar dari kesannya","Indeks yang hanya turun 4 persen membuktikan pasarnya masih sehat, sehingga eksposur tidak perlu diubah","Indikator breadth sedang rusak perhitungannya, karena hasilnya bertentangan dengan pergerakan indeksnya"],
 answer:1,
...
{id:"cta-breadth-h08",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Analis seharusnya menunggu divergensi yang lebih ekstrem lagi sebelum bertindak","Indeks yang naik 14 persen membuktikan divergensi itu adalah sinyal palsu","Breadth mengukur kerapuhan, bukan waktu, sehingga lebih cocok mengatur ukuran daripada memicu keluar","Divergensi breadth terbukti tidak memiliki nilai analitis sama sekali"],
 answer:2,
...
{id:"cta-sis-h15",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Sistem tetap layak sepenuhnya karena profit factor di atas 1 sudah berarti menguntungkan secara keseluruhan","Data 2024 sebaiknya dikeluarkan dari pengujian karena merusak hasil yang sudah stabil sebelumnya","Penurunan sebesar itu normal pada pengujian mana pun dan tidak memerlukan penyelidikan lebih lanjut","Data 2024 berfungsi sebagai uji luar sampel, dan penurunan sebesar itu menandakan sebagian keunggulannya tidak kokoh"],
 answer:3,
...
{id:"cta-sis-h16",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Sensitivitas terhadap biaya dan slippage, yang jauh lebih menggerus sistem berfrekuensi tinggi","Sistem A pasti lebih baik karena menghasilkan lebih banyak peluang","Sistem B pasti lebih baik karena lebih sedikit keputusan yang harus diambil","Frekuensi transaksi tidak berpengaruh selama expectancy keduanya sama"],
 answer:0,
...
{id:"cta-pf-h11",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Pemangkasan itu pasti menurunkan imbal hasil karena pilihan menjadi lebih sedikit","Keunggulan memang menjadi lebih pekat, tetapi dampak satu kesalahan analisis juga menjadi dua kali lebih besar","Portofolio dengan 12 saham selalu lebih baik karena diversifikasi 25 saham berlebihan","Jumlah saham tidak berpengaruh terhadap imbal hasil maupun risiko portofolio"],
 answer:1,
...
{id:"cta-pf-h12",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Analis seharusnya membuka lindung nilai lebih cepat agar tidak menggerus kenaikan","Lindung nilai gagal karena seharusnya melindungi tanpa mengurangi potensi kenaikan","Hasil itu adalah konsekuensi yang melekat pada lindung nilai, dan yang perlu dievaluasi adalah dasar keputusannya","Lindung nilai terbukti merugikan sehingga sebaiknya tidak pernah dipakai"],
 answer:2,
...
{id:"cta-as-h13",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Menyimpulkan saham itu salah harga dan segera membelinya","Mengabaikan divergensinya karena harga komoditas lebih menentukan","Menyimpulkan bahwa hubungan antara saham tambang dan komoditas tidak pernah ada","Menelusuri penyebab spesifik emiten seperti beban utang, aksi korporasi, atau masalah produksi"],
 answer:3,
...
{id:"cta-as-h14",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Struktur pasar berbeda, termasuk ketiadaan gap antarsesi dan karakter volatilitas yang lain","Analisis teknikal memang tidak berlaku pada pasar valuta asing","Sistem itu sebenarnya tidak pernah bekerja, termasuk pada saham","Pasar valas terlalu likuid sehingga tidak memiliki pola sama sekali"],
 answer:0,
...
{id:"cta-statistik-h12",module:"cta-statistik",level:"CTA",difficulty:"sulit",
 ...
 options:["Periode 36 bulan sudah pasti cukup untuk menyimpulkan keandalan strategi ini dalam jangka panjang","Hasil yang sangat stabil pada strategi pasar patut diperiksa terhadap kemungkinan risiko ekor yang belum muncul","Rata-rata 1,2 persen per bulan terlalu kecil untuk strategi aktif yang menanggung risiko sebesar itu","Standar deviasi 0,4 persen menandakan datanya tidak cukup panjang untuk mewakili berbagai kondisi pasar"],
 answer:1,
...
{id:"cta-statistik-h13",module:"cta-statistik",level:"CTA",difficulty:"sulit",
 ...
 options:["Korelasi tidak relevan selama kedua strategi memiliki expectancy positif","Data lima tahun terlalu pendek sehingga angka korelasinya tidak dapat dipakai","Memeriksa korelasinya khusus pada periode penurunan pasar, bukan hanya rata-rata lima tahun","Korelasi di bawah 0,5 selalu berarti kedua strategi sepenuhnya independen"],
 answer:2,
...
{id:"cta-cs-h05",module:"cta-candle",level:"CTA",difficulty:"sulit",
 ...
 options:["Segera menambah posisi karena engulfing sudah dikonfirmasi volume besar","Membatalkan skenario bullish karena doji menandakan pembalikan","Mengabaikan doji sepenuhnya karena volumenya terlalu tipis untuk bermakna","Menunggu, karena doji bervolume tipis belum membatalkan tetapi juga belum mengonfirmasi sinyalnya"],
 answer:3,
...
{id:"cta-cs-h06",module:"cta-candle",level:"CTA",difficulty:"sulit",
 ...
 options:["Sebagian besar tidak bermakna, dan penyaringan lokasi terhadap level kunci akan memangkasnya drastis","Bursa sedang berada di titik dasar karena begitu banyak sinyal bullish muncul","Jumlah sebanyak itu membuktikan pola hammer tidak pernah memiliki nilai","Seluruh 340 pola tersebut layak ditindaklanjuti dengan ukuran posisi kecil"],
 answer:0,
