...
{id:"rta-chart-h09",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Keduanya salah karena grafik tidak boleh dipakai pada saham yang pernah memecah nominal","Grafik aritmetika, karena penyesuaian data selalu menghilangkan informasi yang penting","Grafik yang disesuaikan, karena pemecahan nominal tidak mengubah nilai kepemilikan pemegang saham","Grafik aritmetika, karena harga per lembar memang benar-benar turun pada hari itu"],
 answer:2,
...
{id:"rta-chart-h10",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Kenaikan kedua tampak dua kali lebih tinggi karena selisih poinnya memang dua kali lipat","Kenaikan kedua tampak lebih rendah karena skala logaritmik memampatkan harga tinggi secara keliru","Keduanya tidak dapat dibandingkan karena skala logaritmik tidak mengenal konsep persentase","Sama tingginya, karena keduanya kenaikan 100 persen, sehingga laju perubahan lebih jujur terbaca"],
 answer:3,
...
{id:"rta-chart-h11",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Saat menilai tren jangka sangat panjang, karena kebisingan intrahari disaring dan strukturnya lebih jelas","Saat memperdagangkan sesi harian, karena harga penutupan menentukan seluruh keputusan intrahari","Saat menghitung pola candlestick, karena garis mempertegas bentuk badan setiap lilin","Grafik garis tidak pernah lebih berguna dan hanya dipakai karena keterbatasan data"],
 answer:0,
...
{id:"rta-chart-h12",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Dua sumbu harga berbeda membuat grafik tidak dapat ditampilkan sama sekali","Kekuatan relatif dapat salah terbaca karena pergerakan yang berbeda besar tampak sama besar","Tidak ada risiko selama kedua grafik memakai rentang waktu yang sama panjang","Risikonya hanya pada tampilan, sedangkan kesimpulan analisisnya tetap akurat"],
 answer:1,
...
{id:"rta-chart-h13",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Lemah dalam segala hal karena analisis harga mustahil dilakukan tanpa sumbu waktu","Sifat ini tidak berpengaruh karena point and figure sesungguhnya memiliki sumbu waktu tersembunyi","Unggul menyaring pergerakan kecil dan memperjelas level, tetapi lemah untuk analisis berbasis waktu seperti siklus","Unggul dalam segala hal karena menghilangkan waktu berarti menghilangkan seluruh kebisingan"],
 answer:2,
...
{id:"rta-chart-h14",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Metode penyambungan hanya urusan administratif dan tidak memengaruhi analisis harga","Kontrak berjangka tidak boleh dianalisis secara teknikal dalam keadaan apa pun","Semua penyedia data memakai metode yang sama sehingga perbedaan itu tidak pernah muncul","Level historis dan hasil uji balik dapat berubah nyata hanya karena metode penyambungannya berbeda"],
 answer:3,
...
{id:"rta-trend-h07",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Menetapkan aturannya di muka dan menerapkannya konsisten, karena keduanya sah asal tidak dipilih setelah kejadian","Garis berbasis harga terendah selalu benar karena mencakup seluruh rentang pergerakan harga","Garis berbasis penutupan selalu benar karena harga penutupan adalah satu-satunya yang bermakna","Kedua garis harus dibuang dan diganti dengan rata-rata bergerak yang lebih objektif"],
 answer:0,
...
{id:"rta-trend-h09",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Grafik jam yang dipakai karena paling mutakhir dan paling cepat memberi sinyal","Ketiga timeframe harus dirata-rata untuk memperoleh satu arah tunggal yang sahih","Mingguan menentukan arah, harian menandai koreksi yang sedang berjalan, dan jam mencari titik masuknya","Ketiganya bertentangan sehingga tidak ada posisi yang boleh dibuka sampai semuanya searah"],
 answer:2,
...
{id:"rta-trend-h11",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Pasar mendatar tidak punya tren untuk digambar, sehingga garis itu tidak mencerminkan apa pun","Masalahnya hanya pada jumlah titik sentuh yang kurang, dan garisnya sah bila ditambah satu titik lagi","Garis tren memang boleh ditarik kapan saja karena selalu memberikan informasi berguna","Masalahnya pada pilihan skala grafik, bukan pada keadaan pasar yang mendatar"],
 answer:0,
...
{id:"rta-level-h06",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Tidak berubah, karena kekuatan support hanya ditentukan volume pada pembentukan awalnya","Tidak dapat dinilai, karena jumlah pengujian tidak berkaitan dengan kekuatan sebuah level","Makin rapuh, karena setiap pengujian menghabiskan sebagian permintaan yang tersedia di level itu","Makin kuat, karena semakin sering bertahan berarti semakin banyak pembeli yang membelanya"],
 answer:2,
...
{id:"rta-level-h07",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Level itu tetap menjadi support karena sifat sebuah level tidak berubah setelah terbentuk","Level itu kehilangan seluruh maknanya setelah sekali ditembus dan dapat diabaikan","Harga akan langsung menembusnya karena level yang pernah ditembus tidak lagi menahan","Level itu berubah menjadi resistance karena pembeli lama yang terjebak menjual saat kembali ke titik impas"],
 answer:3,
...
{id:"rta-level-h08",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Konfluensi, yang meningkatkan peluang level itu bertahan dan memberi stop yang lebih ringkas","Kebetulan statistik yang tidak menambah kekuatan level tersebut sama sekali","Divergensi, karena tiga metode berbeda tidak seharusnya menunjuk ke level yang sama","Redundansi, sehingga dua di antara tiga alat itu harus dibuang dari analisis"],
 answer:0,
...
{id:"rta-level-h09",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Yang sahih adalah penarikan yang menghasilkan level terdekat dengan harga saat ini","Ayunan yang dipilih harus merupakan pergerakan bermakna yang diakui struktur grafik, bukan titik yang dipilih sesuka hati","Penarikan dari titik terendah absolut selalu yang paling sahih dalam setiap keadaan","Keduanya sahih sehingga seluruh level dari kedua penarikan dapat dipakai bersamaan"],
 answer:1,
...
{id:"rta-level-h10",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Bursa secara teknis memperlambat perdagangan setiap kali harga menyentuh angka bulat","Angka bulat hanya berperan pada indeks dan tidak pernah berlaku pada saham individu","Banyak pesanan beli dan jual ditempatkan di angka bulat, sehingga di situ benar-benar menumpuk pasokan dan permintaan","Angka bulat memiliki sifat matematis khusus yang memengaruhi pergerakan harga"],
 answer:2,
...
{id:"rta-level-h11",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Memperlakukannya sebagai penembusan biasa karena analisis teknikal tidak mempedulikan sebab pergerakan","Mengabaikan seluruh grafik saham itu karena aksi korporasi membuat datanya tidak dapat dipakai","Menunggu sampai rights issue selesai dan menghapus periode itu dari grafik sepenuhnya","Memeriksa apakah penurunan sepadan dengan pengenceran kepemilikan sebelum membacanya sebagai penembusan teknikal"],
 answer:3,
...
{id:"rta-ind-h06",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Memperlakukannya sebagai tanda kekuatan tren dan mengikuti harga, bukan sebagai sinyal jual","Menjual seluruh posisi karena RSI di atas 70 selalu berarti harga sudah terlalu tinggi","Menunggu RSI menyentuh 90 sebelum mempertimbangkan penjualan apa pun","Mengganti RSI dengan periode lebih panjang sampai bacaannya turun di bawah 70"],
 answer:0,
...
{id:"rta-ind-h07",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Jumlah tujuh sinyal terlalu sedikit untuk dinilai sehingga belum ada masalah apa pun","Alat pengikut tren dipakai pada pasar tanpa tren, sehingga menghasilkan sinyal bolak-balik yang merugi","Periode rata-rata bergerak yang dipakai terlalu panjang sehingga sinyalnya terlambat","Sistem persilangan memang selalu merugi dan tidak layak dipakai pada kondisi apa pun"],
 answer:1,
...
{id:"rta-ind-h08",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Kekeliruannya hanya pada tampilan layar yang menjadi terlalu penuh dan sulit dibaca","Keempat indikator itu tidak boleh dipakai bersamaan karena rumusnya saling bertentangan","Keempatnya mengukur hal yang hampir sama, sehingga kesepakatan itu hanya satu bukti yang diulang empat kali","Tidak ada kekeliruan karena semakin banyak indikator semakin tinggi keandalan sinyalnya"],
 answer:2,
...
{id:"rta-ind-h10",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Persilangan di atas nol terjadi saat momentum jangka menengah sudah positif, sehingga searah tren yang berlaku","Persilangan di bawah nol selalu lebih andal karena harganya masih lebih murah","Keduanya identik karena posisi terhadap garis nol tidak membawa informasi tambahan","Persilangan di atas nol menandakan sinyal palsu karena harga sudah terlambat untuk dibeli"],
 answer:0,
...
{id:"rta-ind-h11",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Angka 18 tidak boleh dipakai karena periode yang sah hanyalah bilangan kelipatan lima","Nilai terbaik yang berdiri sendiri di antara tetangganya biasanya hasil kebisingan, bukan keunggulan nyata","Periode rata-rata bergerak memang tidak boleh diubah dari angka baku yang sudah lazim dipakai","Masalahnya hanya pada waktu komputasi tambahan yang dibutuhkan untuk menguji ulang"],
 answer:1,
...
{id:"cta-pf-h05",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Tidak efektif sama sekali, karena penyebaran hanya bermakna bila melibatkan kelas aset berbeda","Tidak dapat dinilai tanpa mengetahui bobot masing-masing saham dalam portofolio","Terbatas, karena kesamaan gaya dan ukuran membuat semuanya jatuh bersama saat selera risiko pasar berbalik","Sangat efektif, karena delapan sektor berbeda sudah menghapus hampir seluruh risiko tidak sistematis"],
 answer:2,
...
{id:"cta-pf-h06",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Kontribusi keduanya sama besar karena nilai rupiah yang diinvestasikan juga sama","Saham pertama lebih berisiko karena volatilitasnya yang rendah membuatnya sulit dijual","Volatilitas masing-masing saham tidak berkaitan dengan risiko portofolio secara keseluruhan","Saham kedua menyumbang sekitar empat kali lebih besar terhadap gejolak portofolio meski nilainya sama"],
 answer:3,
...
{id:"cta-pf-h07",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Penyebaran risiko justru menghilang tepat pada saat paling dibutuhkan, sehingga perlu lapis perlindungan lain","Korelasi yang meningkat menguntungkan karena seluruh aset akan pulih bersamaan","Gejala ini hanya terjadi pada data harian dan tidak berpengaruh pada portofolio jangka panjang","Portofolio menjadi lebih aman karena pergerakan yang seragam lebih mudah diperkirakan"],
 answer:0,
...
{id:"cta-pf-h08",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Menambah posisi itu lagi karena kenaikannya membuktikan pilihan awalnya tepat","Menimbang antara membiarkan pemenang berjalan dan risiko satu posisi yang kini menentukan nasib portofolio","Selalu memangkasnya kembali ke 5 persen karena bobot awal adalah aturan yang tidak boleh dilanggar","Selalu membiarkannya karena memangkas pemenang adalah kesalahan terbesar dalam berinvestasi"],
 answer:1,
...
{id:"cta-pf-h09",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Mengabaikan beta karena ukuran ini hanya berlaku pada pasar yang sedang naik","Menjual seluruh portofolio karena lindung nilai selalu lebih mahal daripada menjual langsung","Melakukan lindung nilai dengan menjual kontrak berjangka indeks sebesar eksposur beta yang ingin dinetralkan","Membeli lebih banyak saham berbeta tinggi agar rata-rata betanya turun dengan sendirinya"],
 answer:2,
...
{id:"cta-pf-h10",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Penyeimbangan berkala tidak memiliki kelemahan apa pun karena selalu mengembalikan risiko ke rencana","Kelemahannya hanya pada biaya transaksi yang timbul setiap kuartal","Aturan ini membuat portofolio menjadi terlalu terkonsentrasi pada posisi yang menang","Penyeimbangan berkala memangkas posisi yang sedang menang dan menambah yang kalah, berlawanan dengan arah tren"],
 answer:3,
...
{id:"cta-sis-h09",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Sistem dengan frekuensi tinggi sangat rapuh terhadap biaya, sehingga biaya harus dihitung sejak awal perancangan","Biaya transaksi merupakan faktor kecil yang dapat diabaikan pada tahap perancangan sistem","Sistem itu tetap layak dipakai karena hasil sebelum biaya membuktikan logikanya benar","Masalahnya pada besaran biaya yang dikenakan pialang, bukan pada rancangan sistemnya"],
 answer:0,
...
{id:"cta-sis-h10",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Sistem mekanis memang seharusnya selalu disaring lebih dulu oleh penilaian manusia","Statistik sistem menjadi tidak berarti karena yang dijalankan bukan lagi sistem yang diuji","Tidak ada risiko selama penilaian manusia dilakukan oleh analis yang berpengalaman","Risikonya hanya pada satu transaksi itu saja dan tidak berpengaruh pada jangka panjang"],
 answer:1,
...
{id:"cta-sis-h11",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Kesulitannya hanya pada rumitnya perhitungan yang harus dilakukan setiap hari","Sistem pengikut tren sebenarnya mudah dijalankan karena sinyalnya jarang muncul","Rentetan kekalahan panjang terjadi wajar, sehingga keyakinan sering runtuh justru menjelang transaksi besar datang","Sistem dengan rasio kemenangan di bawah 50 persen secara matematis tidak mungkin menguntungkan"],
 answer:2,
...
{id:"cta-sis-h12",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Memperketat stop menjadi 0,5R agar setiap kerugian menjadi lebih kecil","Menaikkan rasio kemenangan dengan memperkecil target menjadi 1R","Menambah indikator penyaring sampai jumlah sinyalnya berkurang setengah","Mengganti target tetap dengan trailing stop agar tren besar tidak terpotong di 2R"],
 answer:3,
...
{id:"cta-sis-h13",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Menguji pada banyak saham dan pasar lain, karena hasil yang hanya berlaku pada satu instrumen patut dicurigai","Menguji ulang pada saham yang sama dengan periode data yang lebih panjang lagi","Menguji dengan modal yang lebih besar untuk memastikan hasilnya berskala","Menguji ulang dengan parameter yang dioptimalkan sekali lagi pada data terbaru"],
 answer:0,
...
{id:"cta-sis-h14",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Uji balik memang tidak perlu memperhatikan volume karena hanya menyimulasikan harga","Dampak pasar diabaikan, padahal pesanan sebesar itu akan menggerakkan harga melawan pelakunya sendiri","Tidak ada masalah selama volume hariannya masih lebih besar daripada jumlah yang dibeli","Masalahnya hanya pada waktu eksekusi yang lebih lama, bukan pada harga yang diperoleh"],
 answer:1,
...
{id:"cta-as-h07",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Indeks saham pasti akan jatuh karena rasio hanya dapat naik bila penyebutnya turun","Rasio antaraset tidak dapat dianalisis secara teknikal karena bukan harga sesungguhnya","Kepemimpinan relatif berpindah ke emas, sehingga bobot aset lindung nilai layak ditinjau ulang","Emas pasti akan naik dalam harga mutlak karena rasionya menembus ke atas"],
 answer:2,
...
{id:"cta-as-h08",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Kedua pasar sepenuhnya terpisah sehingga pergerakannya tidak saling memberi informasi","Imbal hasil obligasi yang naik selalu berarti saham akan segera naik lebih tinggi lagi","Hubungan antarpasar hanya berlaku antara komoditas dan mata uang, bukan obligasi dan saham","Biaya modal yang meningkat pada akhirnya menekan penilaian saham, terutama saham pertumbuhan"],
 answer:3,
...
{id:"cta-as-h09",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Harga komoditas berdenominasi dolar cenderung tertekan karena menjadi lebih mahal bagi pembeli mata uang lain","Harga komoditas selalu naik bersama dolar karena keduanya sama-sama aset lindung nilai","Penguatan dolar tidak memiliki hubungan apa pun dengan harga komoditas global","Hanya harga emas yang terpengaruh sedangkan komoditas lain sepenuhnya kebal"],
 answer:0,
...
{id:"cta-as-h10",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Rotasi sektor hanya mencerminkan arus dana jangka pendek tanpa kaitan dengan ekonomi","Sektor yang unggul bergeser mengikuti tahapan siklus, sehingga kepemimpinan memberi petunjuk posisi ekonomi saat ini","Seluruh sektor bergerak bersamaan sehingga kekuatan relatif tidak membawa informasi","Sektor dengan kekuatan relatif terlemah selalu yang paling layak dibeli lebih dulu"],
 answer:1,
...
{id:"cta-as-h12",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Mengabaikannya karena korelasi sepuluh tahun jauh lebih kuat daripada enam bulan terakhir","Menghentikan kepemilikan aset itu seketika karena korelasi negatifnya terbukti hilang","Menambah kepemilikan aset itu karena pergerakan searah menandakan keduanya sama-sama akan naik","Meninjau kembali asumsi lindung nilainya, karena korelasi historis tidak menjamin perilaku masa depan"],
 answer:3,
