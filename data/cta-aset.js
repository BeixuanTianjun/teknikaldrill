...
{id:"cta-as-001",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Naik, karena kuponnya menjadi lebih menarik dibanding penerbitan baru","Turun, karena kupon tetapnya kalah menarik dibanding imbal hasil pasar","Tetap, karena kuponnya sudah dikunci sampai tanggal jatuh tempo","Bergerak searah, karena harga dan imbal hasil sama-sama mengikuti suku bunga"],
 answer:1,
...
{id:"cta-as-003",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Dolar menguat, karena angkanya bertambah besar","Euro menguat, karena dibutuhkan lebih banyak dolar per satu euro","Keduanya menguat terhadap mata uang lain di luar pasangan itu","Euro melemah, karena nilainya diukur dalam satuan dolar"],
 answer:1,
...
{id:"cta-as-004",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Perdagangan 24 jam terdesentralisasi sehingga gap antar sesi relatif jarang","Jam perdagangannya lebih pendek sehingga tiap sesi membentuk gap pembukaan","Adanya satu bursa terpusat yang menerbitkan data volume resmi harian","Pergerakannya lebih lambat sehingga pola teknikal butuh waktu lebih lama"],
 answer:0,
...
{id:"cta-as-006",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Harga kontrak berjangka lebih tinggi dari harga spot","Harga spot lebih tinggi dari harga kontrak berjangka","Harga spot dan harga berjangka berada pada level yang sama","Harga kontrak bulan dekat lebih tinggi dari bulan jauh"],
 answer:0,
...
{id:"cta-as-007",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Kelangkaan pasokan jangka pendek sehingga barang fisik dihargai premium","Kelebihan pasokan jangka pendek sehingga harga spot tertekan ke bawah","Biaya penyimpanan yang sangat tinggi untuk komoditas bersangkutan","Permintaan jangka panjang yang diperkirakan jauh melampaui pasokan"],
 answer:0,
...
{id:"cta-as-008",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Menghapus pengaruh biaya rollover dari perhitungan imbal hasil","Menyambung kontrak yang jatuh tempo agar deret historis panjang dapat dianalisis","Menggabungkan beberapa komoditas sejenis menjadi satu indeks harga","Menyamakan satuan harga antar bursa berjangka yang berbeda"],
 answer:1,
...
{id:"cta-as-009",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Transaksi yang terjadi pada sesi perdagangan hari itu","Kontrak yang masih terbuka dan belum diselesaikan","Pelaku pasar yang terdaftar aktif di bursa berjangka","Kontrak yang jatuh tempo pada bulan berjalan"],
 answer:1,
...
{id:"cta-as-010",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Tren naik yang kuat karena didukung masuknya dana baru ke sisi beli","Penutupan posisi jual lama yang mendorong harga naik sementara","Perpindahan posisi dari kontrak bulan dekat ke bulan yang lebih jauh","Kenaikan yang rapuh karena tidak disertai penambahan peserta pasar"],
 answer:0,
...
{id:"cta-as-011",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Posisi kelompok pelaku seperti commercial dan large speculator sebagai ukuran sentimen","Perkiraan harga wajar komoditas menurut konsensus pelaku pasar berjangka","Volume transaksi harian yang dipecah menurut bursa tempat terjadinya","Tingkat margin yang diwajibkan bursa untuk tiap jenis kontrak berjangka"],
 answer:0,
...
{id:"cta-as-012",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Perdagangan 24 jam sepanjang pekan dengan volatilitas yang umumnya tinggi","Jam perdagangan terbatas sehingga gap akhir pekan menjadi sangat sering","Volatilitas yang rendah sehingga sinyal teknikal jarang memberi peluang","Adanya otoritas tunggal yang menetapkan harga acuan harian tiap aset"],
 answer:0,
...
{id:"cta-as-014",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Pergerakan nilai tukar yang mempengaruhi imbal hasil dalam mata uang asalnya","Perbedaan jam perdagangan yang membuat harga penutupan sulit dibandingkan","Biaya kustodian lokal yang berubah mengikuti pergerakan indeks komposit","Batas kepemilikan asing yang membuat posisi tidak dapat dilikuidasi penuh"],
 answer:0,
...
{id:"cta-as-015",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Nilai opsi juga ditentukan peluruhan waktu dan perubahan volatilitas tersirat","Opsi hanya dapat dieksekusi pada tanggal jatuh temponya, bukan sebelum itu","Harga opsi ditetapkan penerbit sehingga tidak mengikuti pergerakan aset dasar","Posisi opsi selalu menuntut penyetoran margin tambahan saat harga bergerak"],
 answer:0,
...
{id:"cta-as-018",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["ETF punya harga intraday lengkap dengan volume, reksa dana hanya punya NAB harian","ETF hanya punya NAB harian, sementara reksa dana diperdagangkan sepanjang sesi","Keduanya sama, karena keduanya sama-sama mengacu pada nilai aset bersihnya","ETF tidak dapat dianalisis secara teknikal karena harganya mengikuti indeks acuan"],
 answer:0,
...
{id:"cta-as-019",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Menggrafikkan selisih harga dua kontrak sebagai deret tersendiri","Menganalisis kontrak yang paling likuid lalu menerapkannya pada kontrak lain","Membandingkan volume kedua kontrak untuk menentukan mana yang memimpin","Menghitung rata-rata harga kedua kontrak lalu mencari penyimpangannya"],
 answer:0,
...
{id:"cta-as-020",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Arah suku bunga dan bentuk kurva imbal hasil yang mempengaruhi margin bunga bersih","Pergerakan harga komoditas energi yang menentukan biaya operasional perbankan","Tingkat inflasi pangan yang mempengaruhi daya beli nasabah ritel bank","Nilai tukar mata uang kripto yang kini menjadi pesaing produk simpanan"],
 answer:0,
...
{id:"cta-as-023",module:"cta-aset",level:"CTA",difficulty:"sedang",
 ...
 options:["Deret imbal hasil seri acuan, misalnya tenor 10 tahun","Harga rata-rata seluruh seri yang beredar di pasar sekunder","Jumlah seri baru yang diterbitkan pemerintah tiap kuartal","Peringkat kredit yang diberikan lembaga pemeringkat internasional"],
 answer:0,
...
{id:"cta-as-024",module:"cta-aset",level:"CTA",difficulty:"sulit",
 ...
 options:["Divergensi yang perlu ditelusuri, mungkin dari ekspektasi laba, utang, atau aksi korporasi","Konfirmasi bahwa harga batu bara akan segera menyusul naik mengikuti sahamnya","Hal biasa, karena harga saham tambang tidak berhubungan dengan komoditasnya","Indikasi kesalahan data, karena keduanya seharusnya bergerak identik"],
 answer:0,
