...
{id:"case-01-q1",caseId:"case-01",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["10.000 lembar","12.500 lembar","15.625 lembar","18.750 lembar"],
 answer:1,
...
{id:"case-01-q3",caseId:"case-01",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Stop menjadi Rp4.010, ukuran posisi naik menjadi 15.625 lembar, dan rasio imbal hasil membaik menjadi sekitar 1 banding 2,3","Stop menjadi Rp4.010, ukuran posisi turun menjadi 10.000 lembar, dan rasio imbal hasil memburuk menjadi sekitar 1 banding 1,5","Stop menjadi Rp3.890, ukuran posisi naik menjadi 15.625 lembar, dan rasio imbal hasil tetap di 1 banding 1,8","Stop menjadi Rp4.010, ukuran posisi tetap 12.500 lembar, dan rasio imbal hasil tidak berubah"],
 answer:0,
...
{id:"case-01-q4",caseId:"case-01",module:"rta-plan",level:"RTA",difficulty:"sulit",
 ...
 options:["Nilai posisi terlalu besar sehingga eksekusinya pasti menggerakkan harga","Posisi setara sekitar 0,5% volume harian sehingga likuiditasnya memadai","Volume harian tidak relevan selama stop loss sudah ditetapkan","Posisi perlu dipecah karena melebihi 10% volume harian saham"],
 answer:1,
...
{id:"case-02-q1",caseId:"case-02",module:"rta-indikator",level:"RTA",difficulty:"sulit",
 ...
 options:["Sinyal jual, karena RSI di atas 70 menandakan harga sudah terlalu mahal","Tanda kekuatan tren, karena pada tren kuat RSI memang dapat bertahan di zona jenuh beli","Sinyal netral, karena RSI tidak berlaku pada saham yang sedang menyentuh resistance","Sinyal beli tambahan, karena momentum sedang berada di titik terkuatnya"],
 answer:1,
...
{id:"case-02-q2",caseId:"case-02",module:"rta-trend",level:"RTA",difficulty:"sulit",
 ...
 options:["Harga berada 7% di atas MA50 harian yang masih menanjak","Tren mingguan sudah berjalan sebelas bulan tanpa jeda berarti","Volume terus menyusut selama enam sesi kenaikan terakhir","Posisi sudah untung 34% dan belum direalisasikan sama sekali"],
 answer:2,
...
{id:"case-02-q4",caseId:"case-02",module:"rta-level",level:"RTA",difficulty:"sulit",
 ...
 options:["Penembusan palsu, karena volume besar di resistance biasanya menandakan distribusi","Penembusan yang sah, dan bekas resistance itu menjadi kandidat support pada pengujian ulang","Sinyal untuk menutup posisi, karena harga sudah mencapai target historisnya","Tidak bermakna sampai harga bertahan di atas level itu selama satu bulan penuh"],
 answer:1,
...
{id:"case-03-q1",caseId:"case-03",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Tetap 6%, karena batas risiko sudah dihitung per posisi hingga level stop","Meremehkan risiko sebenarnya, karena posisi berkorelasi tinggi berperilaku mendekati satu taruhan besar","Melebih-lebihkan risiko, karena lima posisi tetap lebih aman daripada satu posisi tunggal","Tidak dapat dinilai tanpa mengetahui volatilitas masing-masing saham terlebih dahulu"],
 answer:1,
...
{id:"case-03-q2",caseId:"case-03",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Sekitar 28%","Sekitar 33%","Sekitar 39%","Sekitar 45%"],
 answer:2,
...
{id:"case-03-q3",caseId:"case-03",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Menambah jumlah posisi menjadi sepuluh saham agar risikonya lebih tersebar","Menetapkan batas eksposur per sektor dan mengisi sisanya dengan aset berkorelasi rendah","Memperkecil risiko per posisi menjadi 0,6% sambil mempertahankan komposisi sektornya","Mengganti seluruh posisi perbankan dengan saham sektor yang sedang memimpin pasar"],
 answer:1,
...
{id:"case-03-q4",caseId:"case-03",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Korelasi cenderung turun saat pasar jatuh sehingga risikonya akan mengecil sendiri","Korelasi cenderung naik mendekati satu saat krisis, tepat ketika diversifikasi paling dibutuhkan","Korelasi historis bersifat tetap sehingga angkanya dapat dipakai tanpa peninjauan ulang","Korelasi hanya relevan bagi portofolio lintas kelas aset, bukan antar saham satu sektor"],
 answer:1,
...
{id:"case-04-q1",caseId:"case-04",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Win rate 71% dan profit factor 4,6 yang terlalu tinggi untuk strategi mengikuti tren","Enam parameter dioptimalkan, hanya 41 transaksi, dan tanpa pengujian di luar sampel","Maximum drawdown 4,1% yang terlalu kecil untuk periode uji selama lima tahun","Periode uji 2019 sampai 2023 yang terlalu pendek untuk menilai sebuah sistem"],
 answer:1,
...
{id:"case-04-q4",caseId:"case-04",module:"cta-sistem",level:"CTA",difficulty:"sulit",
 ...
 options:["Profit factor turun sedikit tetapi peringkat sistem terhadap tolok ukur tidak berubah","Kinerja tergerus, dan besarnya gerusan bergantung pada frekuensi transaksi serta likuiditas instrumen","Tidak berpengaruh, karena strategi mengikuti tren hanya menghasilkan sedikit transaksi","Hasilnya justru membaik, karena slippage dapat bekerja ke arah yang menguntungkan"],
 answer:1,
...
{id:"case-05-q3",caseId:"case-05",module:"cta-breadth",level:"CTA",difficulty:"sulit",
 ...
 options:["Deflasi dengan pertumbuhan melambat, yang biasanya menguntungkan obligasi","Inflasioner dengan tekanan pada mata uang, yang menguntungkan sektor berbasis komoditas","Pemulihan awal siklus, yang biasanya dipimpin sektor siklikal dan perbankan","Akhir resesi, ketika sektor defensif biasanya memimpin pergerakan pasar"],
 answer:1,
...
{id:"case-05-q4",caseId:"case-05",module:"cta-portfolio",level:"CTA",difficulty:"sulit",
 ...
 options:["Menjual seluruh saham dan berpindah ke kas sampai imbal hasil obligasi berhenti naik","Mengatur bobot sektor dan besar eksposur, sementara waktu masuk keluar tetap mengikuti sinyal harga","Membeli obligasi pemerintah tenor panjang karena imbal hasilnya kini jauh lebih menarik","Mengabaikannya karena analisis teknikal saham tidak berurusan dengan pasar obligasi"],
 answer:1,
...
{id:"case-06-q1",caseId:"case-06",module:"rta-riset",level:"RTA",difficulty:"sulit",
 ...
 options:["Diperbolehkan tanpa syarat selama analis tidak menjual saat riset terbit","Wajib diungkapkan dalam riset, karena pembaca berhak menilai independensi analisisnya","Dilarang sepenuhnya, sehingga analis harus menjual posisinya sebelum riset diterbitkan","Cukup dilaporkan kepada atasan, tanpa perlu dicantumkan dalam dokumen risetnya"],
 answer:1,
...
{id:"case-06-q4",caseId:"case-06",module:"rta-riset",level:"RTA",difficulty:"sulit",
 ...
 options:["Menerbitkan riset lengkap dengan pengungkapan posisi, level pembatalan, dan horizon waktunya","Menunda penerbitan sampai ia menjual seluruh posisi pribadinya terlebih dahulu","Menerbitkan riset tanpa nama agar benturan kepentingannya menjadi tidak relevan","Menyerahkan penulisan kepada analis lain agar risetnya terbebas dari benturan kepentingan"],
 answer:0,
