...
{id:"cta-teori-h02",module:"cta-teori",level:"CTA",difficulty:"sulit",
 ...
 options:["Pengujian seharusnya memakai data intraday agar jumlah sampelnya mencukupi","Pada 200 pengujian, sekitar dua temuan signifikan diharapkan muncul murni karena kebetulan","Tingkat 1 persen terlalu ketat sehingga strategi yang benar-benar unggul ikut tersaring","Indikator tidak boleh diuji dalam kombinasi karena sinyalnya saling meniadakan"],
 answer:1,
...
{id:"cta-teori-h03",module:"cta-teori",level:"CTA",difficulty:"sulit",
 ...
 options:["Momentum effect, karena kinerja masa lalu cenderung berlanjut ke periode berikutnya","Survivorship bias, karena hanya perusahaan yang berhasil yang tercatat datanya","Reflexivity, karena persepsi pelaku pasar ikut mengubah fundamental yang dipersepsikan","Herding, karena pelaku pasar mengikuti arah yang sedang diambil mayoritas"],
 answer:2,
...
{id:"cta-teori-h04",module:"cta-teori",level:"CTA",difficulty:"sulit",
 ...
 options:["Look ahead bias, karena data harga dipakai sebelum tanggal ketersediaannya","Data snooping, karena terlalu banyak strategi diuji pada data yang sama","Slippage yang diremehkan, karena likuiditas anggota indeks berubah sepanjang waktu","Survivorship bias, karena emiten yang gugur dari indeks tidak ikut terhitung"],
 answer:3,
...
{id:"cta-teori-h07",module:"cta-teori",level:"CTA",difficulty:"sulit",
 ...
 options:["Investor ritel lebih disiplin mengikuti level teknikal daripada institusi","Bursa memberlakukan aturan perdagangan berbeda untuk saham berkapitalisasi kecil","Sedikitnya pelaku canggih membuat inefisiensi tidak cepat terarbitrase","Volatilitasnya lebih tinggi sehingga polanya lebih mudah dikenali secara visual"],
 answer:2,
...
{id:"cta-teori-h08",module:"cta-teori",level:"CTA",difficulty:"sulit",
 ...
 options:["Salah satu pasti keliru, karena pasar hanya bisa efisien atau tidak efisien","Momentum bukan keunggulan sejati melainkan kompensasi atas risiko yang lebih besar","Analisis teknikal bekerja hanya karena banyak pelaku memakainya secara serentak","Efisiensi bersifat bertingkat dan berubah, sehingga keunggulan ada tetapi tidak permanen"],
 answer:3,
...
{id:"cta-teori-h11",module:"cta-teori",level:"CTA",difficulty:"sulit",
 ...
 options:["Perhitungan indeks dilakukan bursa sehingga datanya lebih akurat","Indeks tidak terpengaruh aksi korporasi sehingga grafiknya tidak perlu disesuaikan","Agregasi meredam peristiwa spesifik emiten sehingga yang tersisa adalah perilaku kolektif","Indeks selalu diperdagangkan dengan volume lebih besar daripada saham anggotanya"],
 answer:2,
...
{id:"rta-dasar-h02",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Kedua indeks harus diabaikan sampai keduanya bergerak dalam arah yang sama","Belum ada konfirmasi tren naik, sehingga sinyalnya dianggap meragukan","Tren naik terkonfirmasi karena indeks industrial adalah acuan utama pasar","Tren turun terkonfirmasi karena indeks transportasi lebih peka terhadap ekonomi"],
 answer:1,
...
{id:"rta-dasar-h03",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Minor trend, karena kedalamannya tidak menentukan penggolongan suatu pergerakan","Fase distribusi, karena koreksi sedalam itu menandakan pemodal awal melepas posisi","Secondary reaction, karena masih berada dalam kisaran sepertiga sampai dua pertiga","Pembalikan primary trend, karena koreksinya sudah melampaui setengah kenaikan"],
 answer:2,
...
{id:"rta-dasar-h04",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Salah satu analis pasti keliru karena hanya ada satu cara menarik garis yang benar","Perbedaan itu tidak penting karena kedua sinyal pada akhirnya akan bertemu","Garis tren sebaiknya ditinggalkan dan digantikan sepenuhnya oleh moving average","Subjektivitas penarikan garis adalah kelemahan nyata yang menuntut aturan tertulis"],
 answer:3,
...
{id:"rta-dasar-h06",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Kebetulan semata, karena level psikologis tidak pernah terbukti berfungsi","Banyak pelaku menempatkan order pada angka bundar, sehingga level itu menjadi nyata karena diyakini","Angka bundar memang memiliki makna matematis khusus dalam pergerakan harga","Bursa menetapkan angka bundar sebagai batas acuan perdagangan harian"],
 answer:1,
...
{id:"rta-dasar-h07",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Analisis teknikal lebih akurat daripada fundamental dalam memperkirakan harga","Regulator mensyaratkan kedua analisis dipakai bersama dalam pengelolaan dana","Keduanya menjawab pertanyaan berbeda: apa yang layak dibeli, dan kapan membelinya","Analisis fundamental tidak dapat diterapkan pada horizon waktu yang pendek"],
 answer:2,
...
{id:"rta-dasar-h08",module:"rta-dasar",level:"RTA",difficulty:"sulit",
 ...
 options:["Kritik itu keliru karena indikator leading mampu mendahului pergerakan harga","Keterlambatan dapat dihilangkan sepenuhnya dengan memakai timeframe lebih kecil","Kritik itu tidak relevan karena analisis teknikal tidak bertujuan memprediksi","Keterlambatan adalah harga dari konfirmasi, dan ditukar dengan berkurangnya sinyal palsu"],
 answer:3,
...
{id:"rta-chart-h02",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Apakah terdapat gap yang belum tertutup pada beberapa sesi sebelumnya","Apakah terjadi aksi korporasi seperti stock split yang belum disesuaikan pada data","Apakah volume pada hari itu jauh melampaui rata-rata hariannya","Apakah indeks sektor mengalami penurunan serupa pada hari yang sama"],
 answer:1,
...
{id:"rta-chart-h03",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Indikator pada grafik lima menit menghasilkan nilai yang berbeda dari grafik harian","Grafik lima menit hanya tersedia bagi anggota bursa, bukan bagi pelaku umum","Rasio noise terhadap sinyal pada grafik itu jauh melampaui horizon posisinya","Grafik lima menit tidak menyediakan data yang cukup panjang untuk analisis tren"],
 answer:2,
...
{id:"rta-chart-h04",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Mempercayainya, karena Heikin Ashi menyaring noise sehingga polanya lebih murni","Mengabaikan candlestick biasa, karena Heikin Ashi lebih mutakhir secara metodologis","Menggabungkan keduanya dengan merata-ratakan level yang dihasilkan masing-masing","Berhati-hati, karena harga pada Heikin Ashi adalah hasil perhitungan, bukan harga transaksi"],
 answer:3,
...
{id:"rta-chart-h06",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Perbandingan hanya sah bila kedua saham berada pada sektor yang sama","Pergerakan saham berharga rendah tampak nyaris datar meski persentasenya besar","Kedua saham tidak dapat ditampilkan bersama karena satuan harganya berbeda","Grafik gabungan selalu memerlukan skala logaritmik agar tren keduanya terbaca"],
 answer:1,
...
{id:"rta-chart-h07",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Area itu selalu menjadi titik awal tren berikutnya setelah konsolidasi berakhir","Area itu menunjukkan tempat pelaku institusi menempatkan order stop loss mereka","Banyak posisi terbentuk di sana, sehingga area itu cenderung menjadi magnet sekaligus zona reaksi","Area itu menandakan harga wajar saham tersebut menurut konsensus pasar"],
 answer:2,
...
{id:"rta-chart-h08",module:"rta-chart",level:"RTA",difficulty:"sulit",
 ...
 options:["Renko memakai harga rata-rata sehingga koreksi tajam ikut terhaluskan","Renko mengabaikan harga penutupan dan hanya memakai harga tertinggi periode","Renko menyesuaikan brick size secara otomatis mengikuti volatilitas pasar","Renko hanya menggambar bata baru bila harga bergerak sebesar brick size, sehingga koreksi kecil terhapus"],
 answer:3,
